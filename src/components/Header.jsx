...
const Header = () => {
    return (
        <header className="bg-white px-[3vw] py-4 flex justify-between items-center fixed w-full z-50 shadow-lg">
            ...
            <div className="hidden md:flex relative justify-center w-[343px]">
                ...
                <input type="text" placeholder="Find Item" className="border border-light-gray placeholder:text-dark-gray placeholder:text-sm placeholder:font-regular px-4 focus:outline-none rounded-md w-full" />
            </div>
            <div className="gap-2 text-[1.5vw] lg:text-[1.3vw] font-regular hidden md:flex">
                <img src={User} alt="user" />
                <p>Accounts</p>
            </div>
            <div className="gap-2 relative text-[1.5vw] lg:text-[1.3vw] font-regular hidden md:flex">
